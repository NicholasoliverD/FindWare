...
<?php if($produto){ ?>
    ...
    <div class="card">
        ...
        <div class="info-produto">
            <p><strong>Produto:</strong> <?php echo h($produto['nome']); ?></p>
            <p><strong>Código:</strong> <?php echo h($codigo); ?></p>
            <p><strong>Estoque atual:</strong> <?php echo h($produto['estoque']); ?></p>
            <p>
                <strong>Localização:</strong>
                Corredor <?php echo h($produto['corredor']); ?> -
                Prateleira <?php echo h($produto['prateleira']); ?> -
                Nível <?php echo h($produto['nivel']); ?>
            </p>
        </div>
        ...
        <form action="salvar_saida.php" method="POST">
            ...
            <input type="hidden" name="codigo_barras" value="<?php echo h($codigo); ?>">
            <input type="hidden" name="produto" value="<?php echo h($produto['nome']); ?>">
