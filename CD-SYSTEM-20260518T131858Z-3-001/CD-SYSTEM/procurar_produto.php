        ...
        <div class="produto-layout">
            ...
            <div class="card">
                ...
                <div class="info-produto">
                    <p><strong>Código:</strong> <?php echo h($produto['codigo_barras']); ?></p>
                    <p><strong>Estoque:</strong> <?php echo h($produto['estoque']); ?></p>
                    <p><strong>Corredor:</strong> <?php echo h($produto['corredor']); ?></p>
                    <p><strong>Prateleira:</strong> <?php echo h($produto['prateleira']); ?></p>
                    <p><strong>Nível:</strong> <?php echo h($produto['nivel']); ?></p>
                </div>

                <div class="acoes">
                    <a href="mapa.php?busca=<?php echo urlencode($produto['codigo_barras']); ?>" class="btn">
                        Ver no Mapa
                    </a>
