...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="titulo">
            ...
            <p>Busca realizada por: <strong><?php echo h($busca); ?></strong></p>
        </div>
        ...
        <div class="tabela-container">
            ...
            <table>
                ...
                <?php if(mysqli_num_rows($resultado) > 0): ?>
                    ...
                    <tr>
                        <td><?php echo h($produto['nome']); ?></td>
                        <td><?php echo h($produto['codigo']); ?></td>
                        <td><?php echo h($produto['codigo_barras']); ?></td>
                        <td><?php echo h($produto['corredor']); ?></td>
                        <td><?php echo h($produto['prateleira']); ?></td>
                        <td><?php echo h($produto['nivel']); ?></td>

                        <td>
                            <span class="badge-estoque <?php echo $produto['estoque'] <= 5 ? 'estoque-baixo' : 'estoque-ok'; ?>">
                                <?php echo h($produto['estoque']); ?>
                            </span>
                        </td>

                        <td>
                            <a href="mapa.php?busca=<?php echo urlencode($produto['codigo']); ?>" class="btn">
                                Ver Mapa
                            </a>
                        </td>
                    </tr>
