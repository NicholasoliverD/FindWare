...
if (empty($codigo_barras) || empty($produto) || $quantidade <= 0 || empty($motivo)) {
    $status = "erro";
    $titulo = "Dados incompletos";
    $mensagem = "Preencha todos os campos e informe uma quantidade válida.";
} else {
